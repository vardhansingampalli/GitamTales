document.addEventListener('DOMContentLoaded', async () => {
    ...
    function createTaleCard(tale) {
        ...
        const commentButtonHTML = `<button class="comment-button text-gray-600 hover:text-blue-500 flex items-center gap-1 transition-colors" data-tale-id="${tale.id}"></button>
